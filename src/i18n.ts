  ...
  zh: {
    ...
    content: {
      ...
      history: {
        ...
        items: [
          { period: '2012.07 — 至今 · 12年+', badge: '现任', co: '北京东方国信科技股份有限公司（BONC）', role: '软件研发工程师 · 多项目开发组长 / 技术负责人', note: '长期服务于电信、金融、政企行业的大型数字化平台项目，负责后端架构设计与开发、技术攻坚、团队协调，近年承担 K8s 容器化运维工作。', wins: ['主导<strong>吉林银行数据免疫系统</strong>：全链路闭环架构，异常检测提速 <strong>20%</strong>', '主导<strong>吉林电信经分大数据平台</strong>重构：宽表加工提速 <strong>4小时+</strong>，自助取数提速 2小时+', '参与<strong>山西银行辰元营销中台</strong>：Spring Cloud 架构，线上线下数据闭环', '负责<strong>吉林联通云平台</strong>：K8s 应用上线与运维，突发问题处置', '负责产品后端架构选型与技术方案评审，指导初中级工程师'], now: true },
      ...
      projects: {
        ...
        items: [
          { tag: '金融 · 数据质量', yr: '2025—2026', title: '吉林银行数据免疫系统', role: '开发组长 / 架构设计', desc: '全行级数据质量管控平台，全闭环架构（规则配置→任务执行→整改→验收），多角色协同工作台，OA接口自动化任务流转。', kpis: ['异常检测 +20%', '100% 闭环', '五年趋势分析'] },
  ...
  en: {
    ...
    content: {
      ...
      projects: {
        ...
        items: [
          { tag: 'Finance · Data Quality', yr: '2025—2026', title: 'Jilin Bank Data Immune System', role: 'Tech Lead / Architecture', desc: 'Bank-wide data quality control platform with a closed-loop architecture. Multi-role collaborative workspace with OA interface automation.', kpis: ['Detection +20%', '100% Closed-loop', '5-Yr Trend Analysis'] },
  ...
  ja: {
    ...
    content: {
      ...
      history: {
        ...
        items: [
          { period: '2012.07 — 現在 · 12年以上', badge: '現職', co: '北京東方国信科技股份有限公司 (BONC)', role: 'ソフトウェア研究開発エンジニア · テックリード', note: '通信、金融、企業向けのデジタルプラットフォームプロジェクトを主導。バックエンドのアーキテクチャ設計、技術的課題の解決、チーム調整、K8sコンテナ運用を担当。', wins: ['<strong>吉林銀行データ免疫システム</strong>を主導：クローズドループアーキテクチャ、異常検知速度<strong>20%</strong>向上', '<strong>吉林通信ビッグデータプラットフォーム</strong>のリファクタリングを主導：ワイドテーブル処理時間を<strong>4時間以上</strong>短縮', '<strong>山西銀行マーケティング基盤</strong>に参加：Spring Cloudアーキテクチャ、O2Oデータ連携', '<strong>吉林聯通クラウドプラットフォーム</strong>を担当：K8sアプリケーション展開とインシデント対応', 'バックエンドのアーキテクチャ選定と若手エンジニアの指導を担当'], now: true },
      ...
      projects: {
        ...
        items: [
          { tag: '金融 · データ品質', yr: '2025—2026', title: '吉林銀行 データ免疫システム', role: 'テックリード / アーキテクチャ設計', desc: '全行レベルのデータ品質管理プラットフォーム。OAインターフェースの自動化を備えたマルチロールコラボレーションワークスペース。', kpis: ['検知速度 +20%', '100% クローズドループ', '5年トレンド分析'] },
